...
buttons = [
    [
        InlineKeyboardButton(
            text="✗ ᴀᴅᴅ ᴍᴇ ᴇʟsᴇ ʏᴏᴜ ɢᴇʏ​ ✗", url="t.me/serafall_leviathan_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        ...
        InlineKeyboardButton(
            text="✗ ᴅᴇᴠᴇʟᴏᴘᴇʀ ✗", url="https://t.me/Sahil_xd_01"
        ),
    ],
]
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_animation(FALLEN_IMG, caption=
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ, \n\n ɪ ᴀᴍ *SEƦAFALL \n\n ᴍʏ ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪꜱ ɪɴ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴀɴᴅ ɴᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ʏᴇᴛ*\n* ɪꜰ ʏᴏᴜ ꜱᴛɪʟʟ ᴡᴀɴᴛ ᴛᴏ ɢᴇᴛ ɪᴛ ʏᴏᴜ ᴄᴀɴ ᴀꜱᴋ ᴛᴏ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ* [ꜱᴀʜɪʟ](tg://user?id=5218766034)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
